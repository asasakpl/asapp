    ...
    <v-row v-if="admin">
      ...
      <v-col>
        <v-content class="pa-0 pl-5" style="overflow: scroll">
          <v-card class="round" style="overflow: scroll;" max-width="90%" max-height="80vh" tile>
            ...
            <v-row>
              <v-col cols="4" class="pr-2 ml-6">
                <v-col class="pb-0">
                  ...
                  <v-text-field v-model="admin.firstName" outlined :disabled="disabled"></v-text-field>
                </v-col>
                <v-col class="pb-0">
              ...
              <v-col cols="4" class="pr-2 ml-6">
                <v-col class="pb-0">
                  ...
                  <v-text-field v-model="admin.lastName" outlined :disabled="disabled"></v-text-field>
                </v-col>
                <v-col class="pb-0">
                  <div class="headline ml-1 mb-3">{{ $t('admin.page.type') }}</div>
                  <v-select
                    :items="types"
                    :disabled="disabled"
                    v-model="admin.type"
