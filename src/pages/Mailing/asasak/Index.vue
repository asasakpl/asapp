  ...
  <v-container fluid>
    <v-row>
      ...
      <v-col class="pa-0" cols="11">
        <v-card class="mx-auto px-auto round" max-height="80vh" max-width="95%" tile v-if="asasak">
          <v-img :aspect-ratio="16 / 9" src="@/assets/newsletter/asasak.jpg" max-height="400">
            <v-row class="lightbox white--text pa-2 fill-height ml-1" align="end">
              <v-col>
          ...
          <v-card-text class="pt-6" style="position: relative;">
            <v-btn absolute color="green" class="white--text" fab large right top to="/asasak/new">
              ...
              <v-row>
                <v-col cols="6">
                  <v-list>
                    <v-list-item>
                      <v-list-item-content>
                        <v-list-item-title class="headline font-weight-medium">Subskrybenci</v-list-item-title>
